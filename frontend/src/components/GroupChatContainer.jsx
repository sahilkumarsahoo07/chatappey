                ...
                >
                    ...
                    <div className={`relative group max-w-[82%] sm:max-w-[75%] md:max-w-[65%] lg:max-w-[60%] min-w-[95px] flex flex-col ${searchActiveId === message._id ? "ring-2 ring-amber-400/70 rounded-xl" : ""}`}>
                        ...
                        >
                            <div
                                style={bubbleStyle}
                                className={`relative flex flex-col w-fit max-w-full px-3 pt-2 pb-2.5 shadow-xs ${bubbleBgColor} ${!isMyMessage && !isWhatsApp ? 'border border-base-content/5' : ''} ${isDeleted ? "opacity-90" : ""}`}
                            >
                                {isDeleted ? (
                                    <>
